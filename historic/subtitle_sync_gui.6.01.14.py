...
class SubtitleSyncApp:
    ...
    def create_widgets(self):
        ...
        self.right_label = tk.Label(right_frame, text="⭢ Synced Subtitle: —", font=("Segoe UI", 9, "bold"))
    ...
    def run_sync(self):
        ...
        self.right_label.config(text=f"⭢ Synced Subtitle: {os.path.basename(transcription_path)}")
