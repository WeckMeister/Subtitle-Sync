...
__version__ = __versionMinor__  + "21"
...
class SubtitleSyncApp:
    ...
    "asr_only": tk.PhotoImage(file="icons/asr_only.png"),
    ...
    def create_ribbon(self):
        ...
        btns = [
            ...
            ("ASR (Whisper Only)", self.run_asr_only, "asr_only"),
    ...
    def run_asr_only(self):
        ...
        with open(asr_path, "w", encoding="utf-8") as f:
            for i, segment in enumerate(segments):
                text = segment.text.strip()
                # Fallback: reconstruct text from individual word tokens
                if not text and hasattr(segment, "words") and segment.words:
                    text = " ".join([w.word for w in segment.words])
